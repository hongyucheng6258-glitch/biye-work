      ...
      <div class="workspace-body">
        ...
        <template v-else>
          ...
          <section v-else class="list-board">
            ...
            <div class="workspace-list"><article v-for="row in records" :key="row.id" class="workspace-card">
...
function resetState() { loading.value = false; error.value = ''; authRequired.value = false; records.value = []; total.value = 0; page.value = 1; keyword.value = ''; category.value = '全部'; detailId.value = null; detailRecord.value = null; imageErrors.value = new Set() }
